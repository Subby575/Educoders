...
export default function BlogCont() {
  ...
  <div class="mx-auto max-w-screen-md px-4 md:px-8">
    <h1 class="mb-4 text-center text-2xl font-bold text-gray-800 sm:text-3xl md:mb-6">Cult of Pedagogy
.</h1>

    <p class="mb-6 text-gray-500 sm:text-lg md:mb-8">
    The goal at WeAreTeachers is “to inspire teachers and help them succeed by sharing practical classroom ideas, the best freebies and giveaways, and  realistic otherwise it will not look very good.<br /><br />
